...
<h2>Downloading the tool sources</h2>
...
<a href="http://www.gnu.org/order/ftp.html" target="_top">main GNU software
download site</a> or any of its mirror sites. It is also available at any of the
<a href="http://sources.redhat.com/mirrors.html" target="_top">
...
from the <a href="http://sources.redhat.com/binutils/" target="_top"> main
binutils development site</a>, but these have not been verified
for use with eCos.<p>
}
...
This is available from the <a href="http://sources.redhat.com/binutils/"
target="_top"> main binutils
...
The <a href="http://gcc.gnu.org/" target="_top">GNU Compiler Collection
web site</a> contains plenty of information about installing and using GCC.

${GCCSNAP-
A <a href="ftp://gcc.gnu.org/pub/gcc/snapshots/index.html" target="_top">
snapshot of the GCC development sources</a> may be used to obtain the most 
...
<a href="ftp://gcc.gnu.org/pub/gcc/releases/index.html" target="_top">
releases page</a>. Both the core distribution and the C++ distribution
...
supporting eCos for $TARGETNAME. A
<a href="ftp://gcc.gnu.org/pub/gcc/snapshots/index.html" target="_top">snapshot
of the GCC development sources</a> should be used to obtain the most
up-to-date compiler with new features and bug fixes.<p>
...
When downloading a snapshot from the <a href="ftp://gcc.gnu.org/pub/gcc/snapshots/" target="_top">
...
Refer to the <a href="http://www.objsw.com/CrossGCC/" target="_top">CrossGCC
FAQ</a> for details about building a standalone version of GCC.<p>

It is strongly recommended you use a <a href="http://gcc.gnu.org/mirrors.html"
target="_top">mirror site</a> close to you, which will result in a faster
...
on the <a href="http://sources.redhat.com/gdb/" target="_top">
GDB home page</a>. 

However, Red Hat has also released an open source graphical front-end to GDB based on
Tcl/Tk called <i>Insight</i>, which has a separate <a href="http://sources.redhat.com/insight/" target="_top">
home page</a>.<p>
...
<a href="/bzip2/" target="_top">bzip2</a> or <a href="http://www.gzip.org/"
target="_top">gzip</a>
compression utilities, depending on your choice of download format.
A <i>patch</i> utility (preferably
<a href="http://www.gnu.org/software/patch/patch.html" target="_top">GNU
patch</a>) is also required.<p>
